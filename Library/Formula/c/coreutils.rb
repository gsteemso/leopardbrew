class Coreutils < Formula
  ...
  url 'http://ftpmirror.gnu.org/coreutils/coreutils-9.7.tar.xz'
  ...
  def install
    ...
    system 'make'
    # `make check` suffers numerous failures, but probably not enough to justify aborting the build.
    system 'make', 'install'
  ...
  test do
    ...
    system bin/'gln', '-fT', 'test', 'test.sha1'
  end
end
