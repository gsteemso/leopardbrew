# Stable release 2017-11-10; Frozen.  Latest release (4.2.0) 2025-11-19 requires C++11(?); checked 2025-11-28.
class Cmake < Formula
  ...
  bottle { sha256 '7ed83fa411209917e876cd0a1396593ee78af1201e4ec952ab32884cf00e0c50' => :tiger_altivec }

  option 'with-completion', 'Install Bash completion (Has potential problems with system bash)'
  option 'without-docs', 'Don’t build man pages'

  depends_on :python2 => :build if MacOS.version <= :snow_leopard and build.with?('docs')
  depends_on 'xz'     => :build
  ...
  def install
    if build.with? 'docs'
      ...
      resources.each{ |r| r.stage { system 'python2', *Language::Python.setup_install_args(buildpath/'sphinx') } }

      # There is a known issue with BSDs / Mac OS & Python2 locale setting.  See (http://bugs.python.org/issue18378#msg215215).
      ENV['LC_ALL'] = 'en_US.UTF-8' if ENV['LC_ALL'] == 'UTF-8'
    end
