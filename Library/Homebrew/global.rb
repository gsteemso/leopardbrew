...
HOMEBREW_LIBRARY       = Pathname.new(ENV['HOMEBREW_LIBRARY'])
  ...
  HOMEBREW_LOAD_PATH   =   HOMEBREW_LIBRARY_PATH
                           # The path to our libraries /when invoking Ruby/.  Is sometimes set to a
                           # custom value during unit testing of Homebrew itself.
...
HOMEBREW_RUBY_PATH     = Pathname.new(ENV['HOMEBREW_RUBY_PATH'])  # Path → our internal Ruby binary
