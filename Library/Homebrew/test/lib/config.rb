...
HOMEBREW_RUBY_LIBRARY  = Pathname.new(File.expand_path("../../..", __FILE__))
HOMEBREW_LOAD_PATH     = [File.expand_path("..", __FILE__), HOMEBREW_RUBY_LIBRARY].join(":")
HOMEBREW_CACHE         = HOMEBREW_PREFIX.parent+"cache"
HOMEBREW_FORMULA_CACHE = HOMEBREW_PREFIX.parent+"formula_cache"
